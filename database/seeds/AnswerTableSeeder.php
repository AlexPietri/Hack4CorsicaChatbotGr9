...
class AnswerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $array = [
            ...
            "Regrouper les Corses et amis de la Corse du monde entier sur une même plate-forme numérique afin de développer des projets en Corse ; tel est le concept de cette initiative nommée « communiti »." => 1,
            "Nous avons pour ambition de donner aux étudiants corses l’opportunité de pouvoir partir se former à l’international, grâce au réseau communiti, ainsi que de mettre en avant leur profil respectif afin de trouver plus facilement un emploi en Corse" => 11,
            "En tant que membre de la Diaspora vous pourrez par exemple connaitre les membres vivants dans la même ville que vous, être à l'écoute des opportunités d'emplois en Corse et peut-être même trouver un emploi via le réseau et revenir travailler dans votre région." => 12,
            "C'est très simple, vous pouvez soit envoyer un email à l'adresse info@communiti.corsica, soit téléphoner directement au 06 84 86 10 49. Nous seront très heureux de répondre à toutes vos questions" => 13,
            "Nous avons une page Facebook. Elle est accessible via l'adresse : https://www.facebook.com/corsicancommuniti/" => 14,
            "Nous avons un compte Twitter. Il est accessible via l'adresse : https://twitter.com/c0mmuniti" => 15,
            "Nous avons une page LinkedIn. Elle est accessible via l'adresse : https://www.linkedin.com/company/communiti-corse/" => 16,
            "Nous organisons des évènements à caractère entrepreneurial en Corse et à l'international. Nous annonçons tous nos évènements via notre plateforme dédiée à cela et accessible à l'adresse suivante : https://events.communiti.corsica" => 17,
            "Ils sont plusieurs ! Parmi eux nous comptons à la fois des entreprises, des institutions publiques et des associations. Par exemple nous pourrions citer Max Immobilier, Cabinet Pantalacci, Impact Diffusion, Empire Cowork, BPIFRANCE, Corse Billet, Equi, l'ADEC, Biomathematica, Pole Emploi, Wild Productions, France Bleu RFCM, Le Journal de la Corse, Novita Prod, France 3 Corse Via Stella, la CAPA M3E, les Corsican Business Women, la CGPME, le Réseau des Télésecrétaires de Corse, le MEDEF, Ricordi di Petru Pà, Paroles de Corse, Corse-Matin, Andemu, In Corsica, le Nuvalinu, Wild Corsica, Media COrsica, Corsica Diaspora, Make Eat Up, Meet Me Before Buying, etc." => 18,
            "Nous vous conseillons de regarder une émission au sujet du réseau, réalisée par nos partenaires Novita Prod et France 3 Corse Via Stella accessible à l'adresse suivante : https://vimeo.com/247816601" => 19,
            "Non, je dirais que je suis plutôt une sorte d'esprit composé de 0 et 1 en attendant l'ordinateur quantique." => 20,
            "Je m'appelle Pasquale, et vous ?" => 21,
            "C’est-à-dire ?" => 22,
            "Pour vous inscrire c'est très simple, il suffit de vous rendre à l'adresse suivante : https://www.communiti.corsica/creation_profil.php" => 23,
